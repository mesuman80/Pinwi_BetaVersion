...
@implementation SendConfirmationCodeToMail
...
-(void)initService:(NSDictionary *)dictionary
{
    ...
    NSString *soapMessage =[NSString stringWithFormat:
                            ...
                            "<soap:Body>\n"
                            "<SendConfirmationCodeToMail xmlns=\"http://tempuri.org/\">\n" ];
    ...
    soapMessage = [soapMessage stringByAppendingString:[NSString stringWithFormat:@"<EmailAddress>%@</EmailAddress>\n",[dictionary valueForKey:@"EmailAddress"]]];
     ...
     soapMessage = [soapMessage stringByAppendingString:@"</SendConfirmationCodeToMail>\n</soap:Body>\n</soap:Envelope>\n"];
    ...
    [soapRequest addValue: @"http://tempuri.org/SendConfirmationCodeToMail" forHTTPHeaderField:@"SOAPAction"];
...
-(void)connectionDidFinishLoadingData:(NSDictionary *)dictionary withService:(UrlConnection *)connection
{
    ...
    [self.sendConfirmationDelegate confirmationCode:[dictionary objectForKey:@"ConfirmationID"]];
}
