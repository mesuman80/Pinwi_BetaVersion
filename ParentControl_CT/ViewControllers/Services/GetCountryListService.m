...
@implementation GetCountryListService
...
-(void)initService:(NSDictionary *)dictionary
{
    ...
    soapMessage = [soapMessage stringByAppendingString:@"</GetCountryList>\n</soap:Body>\n</soap:Envelope>\n"];
    ...
    [soapRequest addValue: @"http://tempuri.org/GetCountryList" forHTTPHeaderField:@"SOAPAction"];
