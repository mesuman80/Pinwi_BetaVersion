...
@implementation GetListofChildsByParentID
...
-(void)initService:(NSDictionary *)dictionary
{
    NSString *soapMessage =[NSString stringWithFormat:
                            ...
                            "<soap:Body>\n"
                            "<GetListofChildsByParentID xmlns=\"http://tempuri.org/\">\n" ];
    ...
    soapMessage = [soapMessage stringByAppendingString:@"</GetListofChildsByParentID>\n</soap:Body>\n</soap:Envelope>\n"];
    ...
    [soapRequest addValue: @"http://tempuri.org/GetListofChildsByParentID" forHTTPHeaderField:@"SOAPAction"];
