//
//  GetPeopleYouMayKnowListByLoggedID.m
//  ParentControl_CT
//
...
@implementation GetPeopleYouMayKnowListByLoggedID
...
-(void)initService:(NSDictionary *)dictionary
{
    ...
    NSString *soapMessage =[NSString stringWithFormat:
                            ...
                            "<soap:Body>\n"
                            "<GetPeopleYouMayKnowListByLoggedID xmlns=\"http://tempuri.org/\">\n" ];
    ...
    soapMessage = [soapMessage stringByAppendingString:[NSString stringWithFormat:@"<LoggedID>%i</LoggedID>\n", [[dictionary valueForKey:@"LoggedID"] integerValue]]];
    soapMessage = [soapMessage stringByAppendingString:[NSString stringWithFormat:@"<PageIndex>%i</PageIndex>\n",[[dictionary valueForKey:@"PageIndex"] integerValue]]];
    soapMessage = [soapMessage stringByAppendingString:[NSString stringWithFormat:@"<NumberOfRows>%i</NumberOfRows>",[[dictionary valueForKey:@"NumberOfRows"] integerValue]]];
    
    soapMessage = [soapMessage stringByAppendingString:@"</GetPeopleYouMayKnowListByLoggedID>\n</soap:Body>\n</soap:Envelope>\n"];
    ...
    [soapRequest addValue: @"http://tempuri.org/GetPeopleYouMayKnowListByLoggedID" forHTTPHeaderField:@"SOAPAction"];
...
{
    NSLog(@"GetPeopleYouMayKnowListByLoggedID connectionDidFinishLoadingData");
