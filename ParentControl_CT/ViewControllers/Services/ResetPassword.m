...
-(void)initService:(NSDictionary *)dictionary
{
    ...
    soapMessage = [soapMessage stringByAppendingString:[NSString stringWithFormat:@"<NewPassword>%@</NewPassword>\n",[dictionary valueForKey:@"NewPassword"]]];
    soapMessage = [soapMessage stringByAppendingString:[NSString stringWithFormat:@"<ConfirmPassword>%@</ConfirmPassword>\n",[dictionary valueForKey:@"ConfirmPassword"]]];
    
    soapMessage = [soapMessage stringByAppendingString:@"</ResetPassword>\n</soap:Body>\n</soap:Envelope>\n"];
    ...
    [soapRequest addValue: @"http://tempuri.org/ResetPassword" forHTTPHeaderField:@"SOAPAction"];
