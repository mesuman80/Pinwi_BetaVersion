//
//  GetListOfClustersOnExploreByChildID.m
//  ParentControl_CT
//
...
@implementation GetListOfClustersOnExploreByChildID
...
-(void)initService:(NSDictionary *)dictionary
{
    ...
    NSString *soapMessage =[NSString stringWithFormat:
                            ...
                            "<soap:Body>\n"
                            "<GetListOfClustersOnExploreByChildID xmlns=\"http://tempuri.org/\">\n" ];
    ...
    soapMessage = [soapMessage stringByAppendingString:@"</GetListOfClustersOnExploreByChildID>\n</soap:Body>\n</soap:Envelope>\n"];
    ...
    [soapRequest addValue: @"http://tempuri.org/GetListOfClustersOnExploreByChildID" forHTTPHeaderField:@"SOAPAction"];
...
{
    NSLog(@"GetListOfClustersOnExploreByChildID connectionDidFinishLoadingData");
...
-(void)connectionFailedWithError:(NSString *)errorMessage withService:(UrlConnection *)connection
{
    ...
    NSLog(@"GetListOfClustersOnExploreByChildID error message %@",errorMessage);
