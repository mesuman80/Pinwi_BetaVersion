...
@implementation GetAfterSchoolCategoriesByOwnerID
...
-(void)initService:(NSDictionary *)dictionary
{
    ...
    NSString *soapMessage =[NSString stringWithFormat:
                            ...
                            "<soap:Body>\n"
                            "<GetAfterSchoolCategoriesByOwnerID xmlns=\"http://tempuri.org/\">\n" ];
    ...
    soapMessage = [soapMessage stringByAppendingString:[NSString stringWithFormat:@"<OwnerID>%@</OwnerID>\n",[dictionary objectForKey:@"OwnerID"]]];
    
    soapMessage = [soapMessage stringByAppendingString:@"</GetAfterSchoolCategoriesByOwnerID>\n</soap:Body>\n</soap:Envelope>\n"];
    ...
    [soapRequest addValue: @"http://tempuri.org/GetAfterSchoolCategoriesByOwnerID" forHTTPHeaderField:@"SOAPAction"];
