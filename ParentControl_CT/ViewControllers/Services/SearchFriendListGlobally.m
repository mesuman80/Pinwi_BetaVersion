...
@implementation SearchFriendListGlobally
...
-(void)initService:(NSDictionary *)dictionary
{
    ...
    NSString *soapMessage =[NSString stringWithFormat:
                            ...
                            "<soap:Body>\n"
                            "<SearchFriendListGlobally xmlns=\"http://tempuri.org/\">\n" ];
    ...
    soapMessage = [soapMessage stringByAppendingString:[NSString stringWithFormat:@"<SearchText>%@</SearchText>\n",[dictionary valueForKey:@"SearchText"]]];
    ...
    soapMessage = [soapMessage stringByAppendingString:[NSString stringWithFormat:@"<NumberOfRows>%li</NumberOfRows>\n",[[dictionary valueForKey:@"NumberOfRows"] integerValue]]];
    
    soapMessage = [soapMessage stringByAppendingString:@"</SearchFriendListGlobally>\n</soap:Body>\n</soap:Envelope>\n"];
    ...
    [soapRequest addValue: @"http://tempuri.org/SearchFriendListGlobally" forHTTPHeaderField:@"SOAPAction"];
...
{
    NSLog(@"SearchFriendListGlobally connectionDidFinishLoadingData");
...
-(void)connectionFailedWithError:(NSString *)errorMessage withService:(UrlConnection *)connection
{
    ...
    NSLog(@"SearchFriendListGlobally error message %@",errorMessage);
