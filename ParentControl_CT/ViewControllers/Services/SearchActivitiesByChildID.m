...
@implementation SearchActivitiesByChildID
...
-(void)initService:(NSDictionary *)dictionary
{
    ...
    NSString *soapMessage =[NSString stringWithFormat:
                            ...
                            "<soap:Body>\n"
                            "<SearchActivitiesByChildID xmlns=\"http://tempuri.org/\">\n" ];
    ...
    soapMessage = [soapMessage stringByAppendingString:@"</SearchActivitiesByChildID>\n</soap:Body>\n</soap:Envelope>\n"];
    ...
    [soapRequest addValue: @"http://tempuri.org/SearchActivitiesByChildID" forHTTPHeaderField:@"SOAPAction"];
...
{
    NSLog(@"SearchActivitiesByChildID connectionDidFinishLoadingData");
...
-(void)connectionFailedWithError:(NSString *)errorMessage withService:(UrlConnection *)connection
{
    ...
    NSLog(@"SearchActivitiesByChildID error message %@",errorMessage);
