...
@implementation AddActivityRating
...
-(void)initService:(NSDictionary *)dictionary
{
    ...
    NSString *soapMessage =[NSString stringWithFormat:
                            ...
                            "<soap:Body>\n"
                            "<AddActivityRating xmlns=\"http://tempuri.org/\">\n" ];
    ...
    soapMessage = [soapMessage stringByAppendingString:[NSString stringWithFormat:@"<ActRatingValue>%@</ActRatingValue>\n",[dictionary objectForKey:@"ActRatingValue"]]];
  //  soapMessage = [soapMessage stringByAppendingString:[NSString stringWithFormat:@"<RatingValue>%@</RatingValue>\n",[dictionary objectForKey:@"RatingValue"]]];
    soapMessage = [soapMessage stringByAppendingString:[NSString stringWithFormat:@"<DaysAgo>%@</DaysAgo>\n",[dictionary objectForKey:@"DaysAgo"]]];
    
    
    soapMessage = [soapMessage stringByAppendingString:@"</AddActivityRating>\n</soap:Body>\n</soap:Envelope>\n"];
    ...
    [soapRequest addValue: @"http://tempuri.org/AddActivityRating" forHTTPHeaderField:@"SOAPAction"];
