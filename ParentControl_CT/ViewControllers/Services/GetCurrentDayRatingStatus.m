...
@implementation GetCurrentDayRatingStatus
-(void)initService:(NSDictionary *)dictionary
{
    ...
    NSString *soapMessage =[NSString stringWithFormat:
                            ...
                            "<soap:Body>\n"
                            "<GetCurrentDayRatingStatus xmlns=\"http://tempuri.org/\">\n" ];
    ...
    soapMessage = [soapMessage stringByAppendingString:@"</GetCurrentDayRatingStatus>\n</soap:Body>\n</soap:Envelope>\n"];
    ...
    [soapRequest addValue: @"http://tempuri.org/GetCurrentDayRatingStatus" forHTTPHeaderField:@"SOAPAction"];
