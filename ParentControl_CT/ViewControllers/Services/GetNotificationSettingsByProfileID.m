...
@implementation GetNotificationSettingsByProfileID
...
-(void)initService:(NSDictionary *)dictionary
{
    ...
    NSString *soapMessage =[NSString stringWithFormat:
                            ...
                            "<soap:Body>\n"
                            "<GetNotificationSettingsByProfileID xmlns=\"http://tempuri.org/\">\n" ];
    ...
    soapMessage = [soapMessage stringByAppendingString:@"</GetNotificationSettingsByProfileID>\n</soap:Body>\n</soap:Envelope>\n"];
    ...
    [soapRequest addValue: @"http://tempuri.org/GetNotificationSettingsByProfileID" forHTTPHeaderField:@"SOAPAction"];
