...
@implementation GetProfileDetailsByLoggedID
...
-(void)initService:(NSDictionary *)dictionary
{
    ...
    NSString *soapMessage =[NSString stringWithFormat:
                            ...
                            "<soap:Body>\n"
                            "<GetProfileDetailsByLoggedID xmlns=\"http://tempuri.org/\">\n" ];
    ...
    soapMessage = [soapMessage stringByAppendingString:@"</GetProfileDetailsByLoggedID>\n</soap:Body>\n</soap:Envelope>\n"];
    ...
    [soapRequest addValue: @"http://tempuri.org/GetProfileDetailsByLoggedID" forHTTPHeaderField:@"SOAPAction"];
...
{
    NSLog(@"GetProfileDetailsByLoggedID connectionDidFinishLoadingData");
...
-(void)connectionFailedWithError:(NSString *)errorMessage withService:(UrlConnection *)connection
{
    ...
    NSLog(@"GetProfileDetailsByLoggedID error message %@",errorMessage);
