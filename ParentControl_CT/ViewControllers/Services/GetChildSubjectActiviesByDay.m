...
@implementation GetChildSubjectActiviesByDay
...
-(void)initService:(NSDictionary *)dictionary
{
    ...
    NSString *soapMessage =[NSString stringWithFormat:
                            ...
                            "<soap:Body>\n"
                            "<GetChildSubjectActiviesByDay xmlns=\"http://tempuri.org/\">\n" ];
    ...
    soapMessage = [soapMessage stringByAppendingString:@"</GetChildSubjectActiviesByDay>\n</soap:Body>\n</soap:Envelope>\n"];
    ...
    [soapRequest addValue: @"http://tempuri.org/GetChildSubjectActiviesByDay" forHTTPHeaderField:@"SOAPAction"];
