...
@implementation GetCityListService
...
-(void)initService:(NSDictionary *)dictionary
{
    ...
    soapMessage = [soapMessage stringByAppendingString:[NSString stringWithFormat:@"<CountryID>%@</CountryID>\n",[dictionary objectForKey:@"CountryID"]]];
    
    soapMessage = [soapMessage stringByAppendingString:@"</GetCityList>\n</soap:Body>\n</soap:Envelope>\n"];
    ...
    [soapRequest addValue: @"http://tempuri.org/GetCityList" forHTTPHeaderField:@"SOAPAction"];
