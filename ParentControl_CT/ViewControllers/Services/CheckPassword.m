...
-(void)initService:(NSDictionary *)dictionary
{
    ...
    NSString *soapMessage =[NSString stringWithFormat:
                            ...
                            "<soap:Body>\n"
                            "<CheckPassword xmlns=\"http://tempuri.org/\">\n" ];
    ...
    soapMessage = [soapMessage stringByAppendingString:[NSString stringWithFormat:@"<Code>%@</Code>\n",[dictionary valueForKey:@"Code"]]];
    
    soapMessage = [soapMessage stringByAppendingString:@"</CheckPassword>\n</soap:Body>\n</soap:Envelope>\n"];
    ...
    [soapRequest addValue: @"http://tempuri.org/CheckPassword" forHTTPHeaderField:@"SOAPAction"];
