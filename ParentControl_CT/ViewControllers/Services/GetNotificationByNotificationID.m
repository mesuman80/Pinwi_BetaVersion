...
#import "GetNotificationByNotificationID.h"
#import "Constant.h"


@implementation GetNotificationByNotificationID
...
-(void)initService:(NSDictionary *)dictionary
{
    ...
    NSString *soapMessage =[NSString stringWithFormat:
                            ...
                            "<soap:Body>\n"
                            "<GetNotificationByNotificationID xmlns=\"http://tempuri.org/\">\n" ];
    ...
    soapMessage = [soapMessage stringByAppendingString:[NSString stringWithFormat:@"<NotificationID>%@</NotificationID>\n",[dictionary objectForKey:@"NotificationID"]]];
    soapMessage = [soapMessage stringByAppendingString:@"</GetNotificationByNotificationID>\n</soap:Body>\n</soap:Envelope>\n"];
    ...
    [soapRequest addValue: @"http://tempuri.org/GetNotificationByNotificationID" forHTTPHeaderField:@"SOAPAction"];
