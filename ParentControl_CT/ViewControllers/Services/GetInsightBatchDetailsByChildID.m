//
//  GetInsightBatchDetailsByChildID.m
//  ParentControl_CT
//
...
@implementation GetInsightBatchDetailsByChildID
-(void)initService:(NSDictionary *)dictionary
{
    ...
    NSString *soapMessage =[NSString stringWithFormat:
                            ...
                            "<soap:Body>\n"
                            "<GetBadgeDetailsByChildIDOnInsight xmlns=\"http://tempuri.org/\">\n" ];
    ...
    soapMessage = [soapMessage stringByAppendingString:@"</GetBadgeDetailsByChildIDOnInsight>\n</soap:Body>\n</soap:Envelope>\n"];
    ...
    [soapRequest addValue: @"http://tempuri.org/GetBadgeDetailsByChildIDOnInsight" forHTTPHeaderField:@"SOAPAction"];
