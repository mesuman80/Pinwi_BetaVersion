...
@implementation GetAfterSchoolActivityDetails
...
-(void)initService:(NSDictionary *)dictionary
{
    ...
    NSString *soapMessage =[NSString stringWithFormat:
                            ...
                            "<soap:Body>\n"
                            "<GetAfterSchoolActivityDetails xmlns=\"http://tempuri.org/\">\n" ];
    ...
    soapMessage = [soapMessage stringByAppendingString:@"</GetAfterSchoolActivityDetails>\n</soap:Body>\n</soap:Envelope>\n"];
    ...
    [soapRequest addValue: @"http://tempuri.org/GetAfterSchoolActivityDetails" forHTTPHeaderField:@"SOAPAction"];
