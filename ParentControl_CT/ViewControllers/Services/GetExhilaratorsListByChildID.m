//
//  GetExhilaratorsListByChildID.m
//  ParentControl_CT
//
...
@implementation GetExhilaratorsListByChildID
...
-(void)initService:(NSDictionary *)dictionary
{
    ...
    NSString *soapMessage =[NSString stringWithFormat:
                            ...
                            "<soap:Body>\n"
                            "<GetExhilaratorsListByChildID xmlns=\"http://tempuri.org/\">\n" ];
    ...
    soapMessage = [soapMessage stringByAppendingString:@"</GetExhilaratorsListByChildID>\n</soap:Body>\n</soap:Envelope>\n"];
    ...
    [soapRequest addValue: @"http://tempuri.org/GetExhilaratorsListByChildID" forHTTPHeaderField:@"SOAPAction"];
...
{
    NSLog(@"GetExhilaratorsListByChildID connectionDidFinishLoadingData");
...
-(void)connectionFailedWithError:(NSString *)errorMessage withService:(UrlConnection *)connection
{
    ...
    NSLog(@"GetExhilaratorsListByChildID error message %@",errorMessage);
