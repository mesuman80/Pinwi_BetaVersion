//
//  GetHolidayDetailsByHolidayDescService.m
//  ParentControl_CT
//
...
@implementation GetHolidayDetailsByHolidayDescService
-(void)initService:(NSDictionary *)dictionary {
    NSString *soapMessage =[NSString stringWithFormat:
                            @"<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                            "<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">\n"
                            "<soap:Body>\n"
                            "<GetHolidayDetailsByHolidayDesc xmlns=\"http://tempuri.org/\">\n" ];
    ...
    soapMessage = [soapMessage stringByAppendingString:@"</GetHolidayDetailsByHolidayDesc>\n</soap:Body>\n</soap:Envelope>\n"];
    ...
    [soapRequest addValue: @"http://tempuri.org/GetHolidayDetailsByHolidayDesc" forHTTPHeaderField:@"SOAPAction"];
