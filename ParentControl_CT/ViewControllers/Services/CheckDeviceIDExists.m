...
@implementation CheckDeviceIDExists
...
-(void)initService:(NSDictionary *)dictionary
{
    ...
    NSString *soapMessage =[NSString stringWithFormat:
                            ...
                            "<soap:Body>\n"
                            "<CheckDeviceIDExists xmlns=\"http://tempuri.org/\">\n" ];
    ...
    soapMessage = [soapMessage stringByAppendingString:[NSString stringWithFormat:@"<DeviceID>%@</DeviceID>\n",[dictionary objectForKey:@"DeviceID"]]];
    
    soapMessage = [soapMessage stringByAppendingString:@"</CheckDeviceIDExists>\n</soap:Body>\n</soap:Envelope>\n"];
    ...
    [soapRequest addValue: @"http://tempuri.org/CheckDeviceIDExists" forHTTPHeaderField:@"SOAPAction"];
