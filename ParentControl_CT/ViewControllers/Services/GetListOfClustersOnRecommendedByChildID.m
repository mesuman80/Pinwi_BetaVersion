//
//  GetListOfClustersOnRecommendedByChildID.m
//  ParentControl_CT
//
...
@implementation GetListOfClustersOnRecommendedByChildID
...
-(void)initService:(NSDictionary *)dictionary
{
    ...
    NSString *soapMessage =[NSString stringWithFormat:
                            ...
                            "<soap:Body>\n"
                            "<GetListOfClustersOnRecommendedByChildID xmlns=\"http://tempuri.org/\">\n" ];
    ...
    soapMessage = [soapMessage stringByAppendingString:@"</GetListOfClustersOnRecommendedByChildID>\n</soap:Body>\n</soap:Envelope>\n"];
    ...
    [soapRequest addValue: @"http://tempuri.org/GetListOfClustersOnRecommendedByChildID" forHTTPHeaderField:@"SOAPAction"];
...
{
    NSLog(@"GetListOfClustersOnRecommendedByChildID connectionDidFinishLoadingData");
...
-(void)connectionFailedWithError:(NSString *)errorMessage withService:(UrlConnection *)connection
{
    ...
    NSLog(@"GetListOfClustersOnRecommendedByChildID error message %@",errorMessage);
