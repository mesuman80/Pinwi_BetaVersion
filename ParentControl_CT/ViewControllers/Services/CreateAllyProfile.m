...
@implementation CreateAllyProfile
...
-(void)initService:(NSDictionary *)dictionary
{
    ...
    NSString *soapMessage =[NSString stringWithFormat:
                            ...
                            "<soap:Body>\n"
                            "<CreateAllyProfile xmlns=\"http://tempuri.org/\">\n" ];
    ...
    soapMessage = [soapMessage stringByAppendingString:[NSString stringWithFormat:@"<Contact>%@</Contact>\n",[dictionary valueForKey:@"Contact"]]];
     ...
     soapMessage = [soapMessage stringByAppendingString:@"</CreateAllyProfile>\n</soap:Body>\n</soap:Envelope>\n"];
    ...
    [soapRequest addValue: @"http://tempuri.org/CreateAllyProfile" forHTTPHeaderField:@"SOAPAction"];
