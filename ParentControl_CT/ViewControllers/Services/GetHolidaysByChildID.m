...
@implementation GetHolidaysByChildID
...
-(void)initService:(NSDictionary *)dictionary
{
    NSString *soapMessage =[NSString stringWithFormat:
                            ...
                            "<soap:Body>\n"
                            "<GetHolidaysByChildID xmlns=\"http://tempuri.org/\">\n" ];
    ...
    soapMessage = [soapMessage stringByAppendingString:@"</GetHolidaysByChildID>\n</soap:Body>\n</soap:Envelope>\n"];
    ...
    [soapRequest addValue: @"http://tempuri.org/GetHolidaysByChildID" forHTTPHeaderField:@"SOAPAction"];
