//
//  SearchActivitiesOnNetworkByClusterID.m
//  ParentControl_CT
//
...
@implementation SearchActivitiesOnNetworkByClusterID
...
-(void)initService:(NSDictionary *)dictionary
{
    ...
    NSString *soapMessage =[NSString stringWithFormat:
                            ...
                            "<soap:Body>\n"
                            "<SearchActivitiesOnNetworkByClusterID xmlns=\"http://tempuri.org/\">\n" ];
    ...
    soapMessage = [soapMessage stringByAppendingString:@"</SearchActivitiesOnNetworkByClusterID>\n</soap:Body>\n</soap:Envelope>\n"];
    ...
    [soapRequest addValue: @"http://tempuri.org/SearchActivitiesOnNetworkByClusterID" forHTTPHeaderField:@"SOAPAction"];
...
{
    NSLog(@"SearchActivitiesOnNetworkByClusterID connectionDidFinishLoadingData");
...
-(void)connectionFailedWithError:(NSString *)errorMessage withService:(UrlConnection *)connection
{
    ...
    NSLog(@"SearchActivitiesOnNetworkByClusterID error message %@",errorMessage);
