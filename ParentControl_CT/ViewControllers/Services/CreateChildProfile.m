...
@implementation CreateChildProfile
...
-(void)initService:(NSDictionary *)dictionary
{
    ...
    NSString *soapMessage =[NSString stringWithFormat:
                            ...
                            "<soap:Body>\n"
                            "<CreateChildProfile xmlns=\"http://tempuri.org/\">\n" ];
    ...
    soapMessage = [soapMessage stringByAppendingString:[NSString stringWithFormat:@"<AutolockTime>%@</AutolockTime>\n",[dictionary valueForKey:@"AutolockTime"]]];
     ...
     soapMessage = [soapMessage stringByAppendingString:@"</CreateChildProfile>\n</soap:Body>\n</soap:Envelope>\n"];
    ...
    [soapRequest addValue: @"http://tempuri.org/CreateChildProfile" forHTTPHeaderField:@"SOAPAction"];
