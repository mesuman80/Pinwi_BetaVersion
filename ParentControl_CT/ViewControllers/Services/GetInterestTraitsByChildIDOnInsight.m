//
//  GetInterestTraitsByChildIDOnInsight.m
//  ParentControl_CT
//
...
@implementation GetInterestTraitsByChildIDOnInsight
-(void)initService:(NSDictionary *)dictionary
{
    ...
    NSString *soapMessage =[NSString stringWithFormat:
                            ...
                            "<soap:Body>\n"
                            "<GetInterestTraitsByChildIDOnInsight xmlns=\"http://tempuri.org/\">\n" ];
    ...
    soapMessage = [soapMessage stringByAppendingString:@"</GetInterestTraitsByChildIDOnInsight>\n</soap:Body>\n</soap:Envelope>\n"];
    ...
    [soapRequest addValue: @"http://tempuri.org/GetInterestTraitsByChildIDOnInsight" forHTTPHeaderField:@"SOAPAction"];
