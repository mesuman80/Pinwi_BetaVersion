...
@implementation GetActivitiesByCatID
...
-(void)initService:(NSDictionary *)dictionary
{
    ...
    NSString *soapMessage =[NSString stringWithFormat:
                            ...
                            "<soap:Body>\n"
                            "<GetActivitiesByCatID xmlns=\"http://tempuri.org/\">\n" ];
    ...
    soapMessage = [soapMessage stringByAppendingString:[NSString stringWithFormat:@"<CategoryID>%@</CategoryID>\n",[dictionary objectForKey:@"CategoryID"]]];
    ...
    soapMessage = [soapMessage stringByAppendingString:@"</GetActivitiesByCatID>\n</soap:Body>\n</soap:Envelope>\n"];
    ...
    [soapRequest addValue: @"http://tempuri.org/GetActivitiesByCatID" forHTTPHeaderField:@"SOAPAction"];
