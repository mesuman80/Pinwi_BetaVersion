...
@implementation GetAfterSchoolActivitiesByDate
...
-(void)initService:(NSDictionary *)dictionary
{
    ...
    NSString *soapMessage =[NSString stringWithFormat:
                            ...
                            "<soap:Body>\n"
                            "<GetAfterSchoolActivitiesByDate xmlns=\"http://tempuri.org/\">\n" ];
    ...
    soapMessage = [soapMessage stringByAppendingString:[NSString stringWithFormat:@"<ActivityDate>%@</ActivityDate>\n",[dictionary valueForKey:@"ActivityDate"]]];
    
    
    soapMessage = [soapMessage stringByAppendingString:@"</GetAfterSchoolActivitiesByDate>\n</soap:Body>\n</soap:Envelope>\n"];
    ...
    [soapRequest addValue: @"http://tempuri.org/GetAfterSchoolActivitiesByDate" forHTTPHeaderField:@"SOAPAction"];
