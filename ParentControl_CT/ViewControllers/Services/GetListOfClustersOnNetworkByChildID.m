//
//  GetListOfClustersOnNetworkByChildID.m
//  ParentControl_CT
//
...
@implementation GetListOfClustersOnNetworkByChildID
...
-(void)initService:(NSDictionary *)dictionary
{
    ...
    NSString *soapMessage =[NSString stringWithFormat:
                            ...
                            "<soap:Body>\n"
                            "<GetListOfClustersOnNetworkByChildID xmlns=\"http://tempuri.org/\">\n" ];
    ...
    soapMessage = [soapMessage stringByAppendingString:@"</GetListOfClustersOnNetworkByChildID>\n</soap:Body>\n</soap:Envelope>\n"];
    ...
    [soapRequest addValue: @"http://tempuri.org/GetListOfClustersOnNetworkByChildID" forHTTPHeaderField:@"SOAPAction"];
...
{
    NSLog(@"GetListOfClustersOnNetworkByChildID connectionDidFinishLoadingData");
...
-(void)connectionFailedWithError:(NSString *)errorMessage withService:(UrlConnection *)connection
{
    ...
    NSLog(@"GetListOfClustersOnNetworkByChildID error message %@",errorMessage);
