//
//  GetListOfActivitiesOnRecommendedByClusterID.m
//  ParentControl_CT
//
...
@implementation GetListOfActivitiesOnRecommendedByClusterID
...
-(void)initService:(NSDictionary *)dictionary
{
    ...
    NSString *soapMessage =[NSString stringWithFormat:
                            ...
                            "<soap:Body>\n"
                            "<GetListOfActivitiesOnRecommendedByClusterID xmlns=\"http://tempuri.org/\">\n" ];
    ...
    soapMessage = [soapMessage stringByAppendingString:@"</GetListOfActivitiesOnRecommendedByClusterID>\n</soap:Body>\n</soap:Envelope>\n"];
    ...
    [soapRequest addValue: @"http://tempuri.org/GetListOfActivitiesOnRecommendedByClusterID" forHTTPHeaderField:@"SOAPAction"];
...
{
    NSLog(@"GetListOfActivitiesOnRecommendedByClusterID connectionDidFinishLoadingData");
...
-(void)connectionFailedWithError:(NSString *)errorMessage withService:(UrlConnection *)connection
{
    ...
    NSLog(@"GetListOfActivitiesOnRecommendedByClusterID error message %@",errorMessage);
