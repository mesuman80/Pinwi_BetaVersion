//
//  GetDelightTraitsByChildIDOnInsight.m
//  ParentControl_CT
//
...
@implementation GetDelightTraitsByChildIDOnInsight
-(void)initService:(NSDictionary *)dictionary
{
    ...
    NSString *soapMessage =[NSString stringWithFormat:
                            ...
                            "<soap:Body>\n"
                            "<GetDelightTraitsByChildIDOnInsight    xmlns=\"http://tempuri.org/\">\n" ];
    ...
    soapMessage = [soapMessage stringByAppendingString:@"</GetDelightTraitsByChildIDOnInsight>\n</soap:Body>\n</soap:Envelope>\n"];
    ...
    [soapRequest addValue: @"http://tempuri.org/GetDelightTraitsByChildIDOnInsight" forHTTPHeaderField:@"SOAPAction"];
