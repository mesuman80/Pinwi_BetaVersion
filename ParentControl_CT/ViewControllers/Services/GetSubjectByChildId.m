...
//
#import "Constant.h"
#import "GetSubjectByChildId.h"

@implementation GetSubjectByChildId
-(void)initService:(NSDictionary *)dictionary
{
    ...
    NSString *soapMessage =[NSString stringWithFormat:
                            ...
                            "<soap:Body>\n"
                            "<GetSubjectActivitiesByChildID xmlns=\"http://tempuri.org/\">\n" ];
    ...
    soapMessage = [soapMessage stringByAppendingString:@"</GetSubjectActivitiesByChildID>\n</soap:Body>\n</soap:Envelope>\n"];
    ...
    [soapRequest addValue: @"http://tempuri.org/GetSubjectActivitiesByChildID" forHTTPHeaderField:@"SOAPAction"];
