...
@implementation GetPastDaysRatingStatus
...
-(void)initService:(NSDictionary *)dictionary
{
    NSString *soapMessage =[NSString stringWithFormat:
                            ...
                            "<soap:Body>\n"
                            "<GetPastDaysRatingStatus xmlns=\"http://tempuri.org/\">\n" ];
    ...
    soapMessage = [soapMessage stringByAppendingString:@"</GetPastDaysRatingStatus>\n</soap:Body>\n</soap:Envelope>\n"];
    ...
    [soapRequest addValue: @"http://tempuri.org/GetPastDaysRatingStatus" forHTTPHeaderField:@"SOAPAction"];
