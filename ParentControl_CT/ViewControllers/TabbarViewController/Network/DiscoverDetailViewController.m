...
@interface DiscoverDetailViewController ()<UrlConnectionDelegate,HeaderViewProtocol,removeFriendDelegate>
...
-(void)connectionDidFinishLoadingData:(NSDictionary *)dictionary withService:(UrlConnection *)connection{
    ...
    if ([connection.serviceName isEqualToString:@"PinWiGetFriendDetailsByFriendID"]) {
...
-(void)onButtonClick:(id)sender
{
    ...
    NSString *fStatus1 = button.titleLabel.text;
    if([fStatus1 isEqualToString:@"Add"])
    {
    ...
    if([fStatus1 isEqualToString:@"Remove"])
    {
    ...
    if([fStatus1 isEqualToString:@"Accept"])
    {
